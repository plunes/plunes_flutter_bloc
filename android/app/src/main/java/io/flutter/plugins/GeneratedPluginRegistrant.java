...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.otpless_flutter.OtplessFlutterPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin otpless_flutter, com.example.otpless_flutter.OtplessFlutterPlugin", e);
    }
    try {
