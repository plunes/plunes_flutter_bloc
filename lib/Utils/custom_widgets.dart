...
class CustomWidgets {
  ...
  Widget searchBar({@required final TextEditingController searchController,
  ...
  Widget rectangularButtonWithPadding({@required final String buttonText,
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: (solutionList[index] == null ||
                            ...
                            fit: BoxFit.contain)
                            : getImageFromUrl(
                            "https://specialities.s3.ap-south-1.amazonaws.com/new-specialization_icons/${solutionList[index]
                                .speciality}.png",
  ...
  Widget getTopSearchesPrevSearchedSolutionRow(List<CatalogueData> solutionList,
      int index,
      {Function onButtonTap,
        TapGestureRecognizer onViewMoreTap,
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: (solutionList[index] == null ||
                              ...
                              fit: BoxFit.contain)
                              : getImageFromUrl(
                              "https://specialities.s3.ap-south-1.amazonaws.com/${solutionList[index]
                                  .speciality}.png",
                              boxFit: BoxFit.contain),
                        ),
                        Padding(
...
//                                            color: PlunesColors.GREENCOLOR))
                              ...
                              (!(solutionList[index].isActive) &&
                                  ...
                                  padding: EdgeInsets.only(
                                      top: AppConfig.verticalBlockSize * 1),
                                  child: Text(
                                    "You have missed ${solutionList[index]
                                        .maxDiscount.toStringAsFixed(
                                        0)}% on your ${solutionList[index]
                                        .service ??
                                        PlunesStrings.NA} Previously",
                                    style: TextStyle(
                                        fontSize: AppConfig.smallFont,
                                        color: Colors.black),
                                  ))
...
//    print("file url is $imageUrl");
  ...
  Widget getRoundedButton(String buttonName,
              ...
              children: <Widget>[
                Container(
                  ...
                  child: getImageFromUrl(
                      "https://specialities.s3.ap-south-1.amazonaws.com/${testAndProcedures[index]
                          .sId}.png",
                      boxFit: BoxFit.contain),
                ),
                Padding(
  ...
  Widget getDocDetailWidget(List<Services> solutions,
      int index,
...
//                          ),
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                (solutions[index] != null &&
                                    ...
                                    ? Text(
                                  "${solutions[index].experience > 100
                                      ? "100+"
                                      : solutions[index]
                                ...
                                !(solutions[index] != null &&
                                    ...
                                    solutions[index].experience > 0)
                                    ? Text(
                                  "${solutions[index].distance?.toStringAsFixed(
                                      1) ?? _getEmptyString()}kms",
                                  style: TextStyle(
                                      color: PlunesColors.GREYCOLOR,
                                      fontSize: 10),
                                )
                        ...
                        children: <Widget>[
                          ...
                          solutions[index].negotiating
                            ...
                            (solutions[index].discount == null ||
                                ...
                                ? ""
                                : " ${PlunesStrings
                                .save} \u20B9 ${(solutions[index].price[0] -
                                solutions[index].newPrice[0])?.toStringAsFixed(
                                2)}",
                            style: TextStyle(
                                fontSize: 14,
                                color: PlunesColors.GREENCOLOR),
                  ...
                  child: InkWell(
                      ...
                      child: getRoundedButton(
                          solutions[index].bookIn == null
                              ? PlunesStrings.book
                              : "${PlunesStrings.bookIn} ${solutions[index]
                              .bookIn}",
                          AppConfig.horizontalBlockSize * 8,
                          solutions[index].negotiating
                              ? PlunesColors.GREYCOLOR
  ...
  Widget buttonWithImageAhead({String imageName,
...
//        print(rating);
  ...
  Widget viewMoreContent(BuildContext context,
      CatalogueData catalogueData,) {
    String replaceFrom = "\\n";
                                    ...
                                    children: <Widget>[
                                      Text(
                                        (chancesPercent == null ||
                                            ...
                                            chancesPercent < 0)
                                            ? '0%'
                                            : '${chancesPercent.toStringAsFixed(
                                            0)}%',
                                        style: TextStyle(
                                            color: Colors.white70,
                                            fontSize: AppConfig.mediumFont,
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Text(
                                    ' \u20B9 ${(num.parse(
                                        actionableInsight.userPrice).floor() /
                                        2)?.toStringAsFixed(0)}',
                                    style: TextStyle(
                                        color: Colors.white70,
                                        fontSize: 20,
    ...
    return AlertDialog(
      content: Container(
        child: Column(
          ...
          children: <Widget>[
            Text(
                "Allow Plunes to access this device's ${permissionName
                    ?.split(".")
                    ?.last}."),
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Column(
                                    ...
                                    children: <Widget>[
                                      Container(
                                        width: AppConfig.horizontalBlockSize *
                                            40,
                                        padding:
...
//                        );
  ...
  Widget showDocPopup(DoctorsData doctorsData, BuildContext context,
      String hospitalName) {
    return Dialog(
  ...
  Widget getProfileInfoView(double height, double width, String icon,
  ...
  Widget appointmentCancellationPopup(String message,
  ...
  Widget requestInvoiceSuccessPopup(String message,
      GlobalKey<ScaffoldState> globalKey) {
    return Dialog(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16.0)),
      elevation: 0.0,
  ...
  Widget getManualBiddingEnterDetailsPopup({GlobalKey<ScaffoldState> globalKey,
  ...
  Widget getSingleButtonForPopup({Function onTap,
    Color textColor,
...
//  }
  ...
  Widget openCartPaymentBillPopup(List<BookingIds> bookingIds,
      GlobalKey globalKey, num price,
      {num credits}) {
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Flexible(
                      flex: 2,
                      child: Text(
                        "Subtotal (${bookingIds.length ?? 0} ${(bookingIds
                            .length == 1) ? "item" : "items"}): ",
                        maxLines: 2,
                        style: TextStyle(
                            fontWeight: FontWeight.normal,
