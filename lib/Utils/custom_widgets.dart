                            ...
                            (!(solutionList[index].isActive) &&
                                ...
                                child: Text(
                                  "You have missed ${solutionList[index]
                                      ...
                                      .service ?? PlunesStrings.NA} Previously",
                                  style: TextStyle(
                                      fontSize: AppConfig.smallFont,
                                      color: Colors.black),
                                ))
...
//    print("file url is $imageUrl");
  ...
  Widget getDocDetailWidget(List<Services> solutions,
      ...
      int currentStep, StreamController timerStream) {
                  ...
                  children: <Widget>[
                          ...
                          children: <Widget>[
                            ...
                            (catalogues[index].experience != null &&
                              ...
                              padding: EdgeInsets.only(
                                  top: AppConfig.verticalBlockSize * .3),
                              child: Text(
                                "Expr ${catalogues[index].experience
                                    .toStringAsFixed(0)} years",
                                style: TextStyle(
                                    color: Color(
                                        CommonMethods.getColorHexFromStr(
                                            "#5D5D5D")),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          "${catalogues[index].distance?.toStringAsFixed(1) ??
