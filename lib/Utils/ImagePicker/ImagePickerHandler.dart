...
class ImagePickerHandler {
  ...
  void init() {
    _forVideo ? imagePicker = new ImagePickerDialog(this, _controller, true) : imagePicker = new ImagePickerDialog(this, _controller, false);
  ...
  openCamera() async {
    ...
    cropImage(image);/// Comment this line if you don't want to crop an image. and Uncomment bellow line for getting image path
...
//    _listener.fetchImageCallBack(image);
  ...
  Future<File> cropImage(File imageFile) async {
    File croppedFile = await ImageCropper.cropImage(sourcePath: imageFile.path, maxWidth: 1080, maxHeight: 1080);
