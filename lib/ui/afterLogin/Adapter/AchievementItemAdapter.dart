...
class _ItemCardState extends State<AchievementItemAdapter> implements DialogCallBack {
...
//                  CommonMethods.goToPage(context, GalleryScreen());
                      ...
                      child: Card(
                        elevation: 5,
                          ...
                          child: Stack(
                            fit: StackFit.expand,
                            children: <Widget>[
                            widget.getAssetImageWidget('assets/images/achievments/gradient/6.jpg'),
                            Align(
                              ...
                              child:  Container(
                                  ...
                                  height: 30,
                                  child: widget.createTextViews('+3', 14 , colorsFile.white, TextAlign.center, FontWeight.normal),decoration: BoxDecoration(
                                  border: new Border.all(color: Colors.transparent),
                                  borderRadius: const BorderRadius.only(bottomLeft: const Radius.circular(10.0), bottomRight: const Radius.circular(10.0)),
                ...
                Container(
                  ...
                  child: widget.createTextViews('Name shdj scvsdsdc dshgsdsd sscscsdsc cscsdccscs', 10 , colorsFile.lightGrey2, TextAlign.center, FontWeight.normal))
              ],
              ));
        }));
  }
