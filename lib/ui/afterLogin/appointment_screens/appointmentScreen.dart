...
class _AppointmentScreenState extends State<AppointmentScreen> with TickerProviderStateMixin, ImagePickerListener {
    ...
    if (insuranceImageRespnse.data!.reports!.length > 0 &&
      ...
      if (response.statusCode == 200) {
        ...
        if(commonModel.success!) {
          ...
          Toast.show("Image Uploaded Successfully", duration: Toast.lengthShort, gravity:  Toast.bottom);

          // Fluttertoast.showToast(msg: "Image Uploaded Successfully");

        } else {
          print("fallll elsedone- $bookingIdForImageUpload");
          Toast.show(commonModel.msg!, duration: Toast.lengthShort, gravity:  Toast.bottom);
