...
class _AccountSettingsState extends State<AccountSettings> {
  ...
  var globalHeight, globalWidth,  _userName = '', _userType = '',_specialization='', _userEmail = '',
       _userLocation = '', _userDOB = '', _userEducation = '', _userCollege, _profRegNo, _practising,
      _experience, _introduction;
  var isSwitched = true;
 ...
 Widget getBody() {
    return Container(
      child: Column(
        children: <Widget>[
          getSettingRow(assetsImageFile.settingNotificationIcon, stringsFile.notifications, 0),
          widget.getDividerRow(context, 0, 0, 0),
          getSettingRow(assetsImageFile.editProfileIcon, stringsFile.editProfile, 1),
          widget.getDividerRow(context, 0, 0, 0),
        ],
      ),
    );
