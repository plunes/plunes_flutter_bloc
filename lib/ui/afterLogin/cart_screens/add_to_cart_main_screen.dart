                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: (bookingIds.service != null &&
                              ...
                              bookingIds.service.imageUrl.contains("https"))
                          ? ClipRRect(
                            ...
                            builder: (context, snapshot) {
                              ...
                              if (snapshot.data != null &&
                                ...
                                if (_requestSuccess.response != null &&
                                  ...
                                  Future.delayed(Duration(milliseconds: 10))
                                      .then((value) {
                                    _showMessages(
                                        _requestSuccess.additionalData ??
                              ...
                              if (snapshot.data != null &&
                                ...
                                if (requestFailed.response != null &&
                                  ...
                                  Future.delayed(Duration(milliseconds: 10))
                                      .then((value) {
                                    _showMessages(requestFailed.failureCause ??
                      ...
                      child: InkWell(
                        onTap: () {
                          showDialog(
                              context: context,
                              builder: (context) {
                                return EditPatientDetailScreen(bookingIds);
                              });
                        },
                        onDoubleTap: () {},
                        child: Container(
